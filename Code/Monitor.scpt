...
on run {downloadsFolder_Path_monitor, MacYTDL_preferences_path_monitor, ytdl_options_monitor, URL_user_entered_monitor, YTDL_response_file_monitor, download_filename_new_monitor, MacYTDL_custom_icon_file_posix_monitor, monitor_dialog_position, YTDL_simulate_response_monitor, diag_Title_quoted_monitor}
	...
	set YTDL_response_file_monitor to quoted form of YTDL_response_file_monitor
	...
	-- Put quotes around each URL - mainly because the ampersand in some Youtube URLs ends up being treated as a delimiter - crude but effective
	set AppleScript's text item delimiters to " "
	set number_of_URLs to number of text items in URL_user_entered_monitor
	-- display dialog "number_of_URLs: " & number_of_URLs
	...
	--display dialog "URL_user_entered_monitor_quoted: " & URL_user_entered_monitor_quoted
	--display dialog "youtube-dl " & ytdl_options_monitor & " " & URL_user_entered_monitor_quoted & " " & "&> " & YTDL_response_file_monitor & " & echo $!"
	
	
	set youtubedl_pid to do shell script shellPath & "cd " & downloadsFolder_Path_monitor & " ; " & "youtube-dl " & ytdl_options_monitor & " " & URL_user_entered_monitor_quoted & " " & "&> " & YTDL_response_file_monitor & " & echo $!"
	...
	set adviser_params to monitor_pid & " " & youtubedl_pid & " " & MacYTDL_custom_icon_file_not_posix_monitor & " " & MacYTDL_preferences_path_monitor & " " & YTDL_response_file_monitor & " " & downloadsFolder_Path_monitor & " " & diag_Title_quoted_monitor & " " & DL_description_monitor & " " & download_filename_new_monitor & " " & download_filename_new_monitor_plain_quoted
