...
on check_subtitles_download_available(shellPath, diag_Title, subtitles_choice, URL_user_entered, theButtonQuitLabel, theButtonReturnLabel, theButtonContinueLabel, MacYTDL_custom_icon_file)
	...
	if check_subtitles_available does not contain "Language  formats" and check_subtitles_available does not contain "Language formats" then
	...
	else if check_subtitles_available contains "Language  formats" or check_subtitles_available contains "Language formats" then
...
-- Handler for forking FFmpeg & FFprobe version checks to ARM or Intel handlers - called by "Check updates" in Utilities Dialog
on check_ffmpeg()
