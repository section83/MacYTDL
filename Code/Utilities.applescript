...
on check_settings(MacYTDL_prefs_file, old_version_prefs, diag_Title, theButtonNoLabel, theButtonYesLabel, MacYTDL_version, MacYTDL_date, MacYTDL_preferences_path, path_to_MacYTDL, X_position, Y_position, theBestLabel, theDefaultLabel, theNoRemuxLabel, resourcesPath, show_yt_dlp, YTDL_version)
	tell application "System Events"
		...
		-- Check on need to add new v1.23 Quicktime compatibility setting to the prefs file
		tell property list file MacYTDL_prefs_file
...
-------------------------------------------------------------------------------------------------------------------------------------------------------
--
-- 	Handlers to update content of Preferences file for v1.10, 1.11, 1.12.1, 1.16, 1.17, 1.18, 1.19, 1.20, 1.21, 1.23, v1.24 and v1.26
--
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- This is called by check_settings_current()
...
---------------------------------------------------
--
-- 		Check v1.21 and v1.23 settings are in place
--
---------------------------------------------------
...
on Get_SBS_Episodes(URL_user_entered, diag_Title, theButtonOKLabel, theButtonCancelLabel, theButtonDownloadLabel, X_position, screen_height, MacYTDL_custom_icon_file, MacYTDL_custom_icon_file_posix, theButtonReturnLabel, skip_Main_dialog, path_to_MacYTDL)
	...
	--	display dialog "SBS_show_name: " & SBS_show_name
	...
	if (count of text items in URL_user_entered) is greater than 6 then
		...
		--		display dialog "season_name_text: " & season_name_text
		...
		--		display dialog "number_of_seasons: " & number_of_seasons
	...
	--	display dialog "user_on_season_name: " & user_on_season_name
	...
	--	display dialog "SBS_show_name: " & SBS_show_name & return & "myNumSeasons: " & myNumSeasons
	...
	repeat with i from 1 to (myNumSeasons)
		...
		--		display dialog "i: " & i & return & "item (i) of seasonName_list: " & (item (i) of seasonName_list)
		...
		--		display dialog "SBS_show_name: " & SBS_show_name & return & "myNumSeasons: " & myNumSeasons & return & "myNumEpisodes: " & myNumEpisodes
		...
		repeat with k from 1 to (myNumEpisodes)
			...
			--			display dialog "item (k) of episodename_list: " & (item (k) of episodename_list)
			...
			--			display dialog "temporary_URL: " & temporary_URL & return & "id_start: " & id_start
			...
			--			display dialog "item (k) of ids_list: " & (item (k) of ids_list)
			...
			--		display dialog "item (k) of episodenumber_list: " & (item (k) of episodenumber_list) as text
		...
		--		display dialog "item (i) of season_episode_list: " & (item (i) of season_episode_list) as text
	...
	--	display dialog "ids_list: " & ids_list as text
	...
	--	display dialog "season_episode_list: " & season_episode_list as text
...
on Show_SBS_Chooser(screen_height, number_of_seasons, myNumSeasons, season_episode_list, user_on_season_name, maxNumEpisodes, X_position, episode_URLs_list, will_show_all_button, path_to_MacYTDL, MacYTDL_custom_icon_file_posix, diag_Title, skip_Main_dialog, landed_number_episodes, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file)
	...
	--	display dialog "season_episode_list: " & season_episode_list
...
-- THIS HANDLER IS A PILE OF MERDE
