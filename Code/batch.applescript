...
on add_To_Batch(URL_user_entered, download_filename, download_filename_new, YTDL_remux_format, MacYTDL_preferences_path, diag_Title, theButtonOKLabel, MacYTDL_custom_icon_file)
	...
	-- v1.31 - 10/4/26 - Need to strip out warnings - later on might show them to user
	if download_filename contains "WARNING: " then
		set download_filename_forming to ""
		repeat with z from 1 to ((count of paragraphs in download_filename) - 1)
			set test_line to (paragraph z of download_filename)
			if test_line does not contain "WARNING: " then
				set download_filename_forming to (download_filename_forming & test_line & return)
			end if
		end repeat
		set download_filename to download_filename_forming
	end if
...
on open_batch_processing(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, theButtonOKLabel, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, diag_Title, window_Position, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	...
	if batchButtonNumberReturned is 5 then
		-- v1.30, 19/12/25 - Moved from beginning of download_batch() - Check that there is a batch file containing some URLs - Will design a better way of avoiding nesting in v1.32
		...
		if (get eof file batch_file) is 0 then
			...
			my open_batch_processing(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, theButtonOKLabel, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, diag_Title, window_Position, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
		end if
		
		if batch_file_empty is false then my download_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, diag_Title, MacYTDL_preferences_path, theButtonOKLabel, MacYTDL_custom_icon_file, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, window_Position, screen_width, screen_height, path_to_MacYTDL, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
		...
		set branch_execution to clear_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, diag_Title, theButtonOKLabel, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
		if branch_execution is "Open" then open_batch_processing(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, theButtonOKLabel, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, diag_Title, window_Position, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	else if batchButtonNumberReturned is 4 then
		remove_last_from_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, theButtonOKLabel, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, diag_Title, window_Position, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	end if
...
on clear_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, diag_Title, theButtonOKLabel, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	-- Check that there is a batch file
	tell application "System Events"
		set batch_file_test to batch_file as string
		if not (exists file batch_file_test) then
...
on remove_last_from_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, theButtonOKLabel, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, diag_Title, window_Position, MacYTDL_custom_icon_file, screen_width, screen_height, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	-- Check that there is a batch file
	tell application "System Events"
		set batch_file_test to batch_file as string
		if not (exists file batch_file_test) then
	...
	if (get eof file batch_file) is 0 then
		...
		display dialog theEmptyBatchFileLabel with title diag_Title buttons {theButtonOKLabel} default button 1 with icon file MacYTDL_custom_icon_file giving up after 600
		return
		--		open_batch_processing(folder_chosen, remux_format_choice, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_remux_format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch)
	end if
	try
		set batch_file_ref to missing value
		set batch_file_ref to open for access file batch_file with write permission
...
on download_batch(folder_chosen, DL_Remux_format, subtitles_choice, YTDL_videoPW, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_recode_remux, YTDL_Merge_Format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_audio_codec, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_limit_rate_value, YTDL_verbose, YTDL_TimeStamps, YTDL_Use_Proxy, YTDL_Get_Cookies, YTDL_Use_Cookies, YTDL_Custom_Settings, YTDL_Custom_Template, YTDL_no_part, YTDL_QT_Compat, DL_Use_YTDLP, YTDL_Resolution_Limit, YTDL_Use_Parts, YTDL_No_Warnings, ADL_Clear_Batch, batch_file, diag_Title, MacYTDL_preferences_path, theButtonOKLabel, MacYTDL_custom_icon_file, theButtonReturnLabel, theButtonDownloadLabel, MacYTDL_custom_icon_file_posix, window_Position, screen_width, screen_height, path_to_MacYTDL, YTDL_Use_netrc, YTDL_Use_netrc_Location, deno_version, YTDL_version)
	...
	--	set ytdl_settings to quoted form of (" --ignore-errors --newline " & YTDL_subtitles & YTDL_STEmbed & YTDL_videoPW & YTDL_credentials & YTDL_format & YTDL_remux_format & " " & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_audio_codec & YTDL_over_writes & YTDL_Thumbnail_Write & YTDL_Thumbnail_Embed & YTDL_metadata & YTDL_limit_rate_value & YTDL_verbose & YTDL_Use_Proxy & YTDL_Use_Cookies & YTDL_no_part & YTDL_Custom_Settings & YTDL_output_template & " " & YTDL_QT_Compat & download_batch_parallel_serial)
	
	set ytdl_settings to quoted form of (" --ignore-errors --newline " & YTDL_subtitles & YTDL_STEmbed & YTDL_videoPW & YTDL_credentials & YTDL_format & YTDL_Resolution_Limit & YTDL_Use_Parts & YTDL_No_Warnings & YTDL_remux_format & YTDL_Merge_Format & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_audio_codec & YTDL_over_writes & YTDL_Thumbnail_Write & YTDL_Thumbnail_Embed & YTDL_metadata & YTDL_limit_rate_value & " " & YTDL_verbose & YTDL_Use_Proxy & YTDL_Get_Cookies & YTDL_Use_Cookies & YTDL_no_playlist & YTDL_no_part & YTDL_Custom_Settings & YTDL_output_template & " " & YTDL_QT_Compat & " " & download_batch_parallel_serial & " " & YTDL_Use_netrc & YTDL_Use_netrc_Location & " ")
