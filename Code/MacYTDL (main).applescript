...
on download_video(folder_chosen, remux_format_choice, subtitles_choice, YTDL_credentials, YTDL_subtitles, YTDL_STEmbed, YTDL_format, YTDL_remux_format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_verbose)
	...
	set ytdl_settings to quoted form of (" --ignore-errors " & YTDL_subtitles & YTDL_STEmbed & YTDL_credentials & YTDL_format & YTDL_remux_format & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_over_writes & YTDL_Thumbnail_Write & YTDL_Thumbnail_Embed & YTDL_metadata & YTDL_verbose & YTDL_output_template & " ")
				...
				if length_each_filename is not 0 then
					...
					if search_for_download is not {} then
						...
						if overwrite_continue_choice is "Overwrite" then
							...
							set ytdl_settings to quoted form of (" --ignore-errors " & YTDL_subtitles & YTDL_STEmbed & YTDL_credentials & YTDL_format & YTDL_remux_format & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_metadata & YTDL_verbose & YTDL_output_template & " ")
							...
							set ytdl_settings to quoted form of (" --ignore-errors " & YTDL_subtitles & YTDL_STEmbed & YTDL_credentials & YTDL_format & YTDL_remux_format & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_over_writes & YTDL_metadata & YTDL_verbose & YTDL_output_template_new & " ")
...
on set_File_Names(YTDL_simulate_response)
	...
	if show_name is "" then -- not an iView show page
		if number_of_URLs is 1 then -- Not a multiple file download
			...
			else --<= Single file download but simulate.txt contains WARNING in first paragraph (iView and non-iView) - need to trim ".mp4<para>" from end of 2nd paragraph which is last line of file - but this fails when there are two or more paragraphs of warnings
...
on download_batch(folder_chosen, remux_format_choice, YTDL_subtitles, YTDL_STEmbed, YTDL_credentials, YTDL_format, YTDL_remux_format, YTDL_Remux_original, YTDL_description, YTDL_audio_only, YTDL_over_writes, YTDL_Thumbnail_Write, YTDL_Thumbnail_Embed, YTDL_metadata, YTDL_verbose)
	...
	set ytdl_settings to quoted form of (" --ignore-errors " & YTDL_subtitles & YTDL_STEmbed & YTDL_credentials & YTDL_format & YTDL_remux_format & YTDL_Remux_original & YTDL_description & YTDL_audio_only & YTDL_over_writes & YTDL_Thumbnail_Write & YTDL_Thumbnail_Embed & YTDL_metadata & YTDL_verbose & YTDL_output_template & " --batch-file " & YTDL_batch_file)
