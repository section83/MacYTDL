...
_YT-DLP_ is the default for all Macs. Python 3.8 is built into the _YT-DLP_ executable. However, Homebrew and MacPorts installs can be used. Detail is in the [Help](https://github.com/section83/MacYTDL/Help.pdf).
...
More detail is available in [the Help file](https://github.com/section83/MacYTDL/Help.pdf) (4.9MB).
