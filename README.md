...
[Download from here](https://github.com/section83/MacYTDL/releases/download/1.14/MacYTDL-v1.14.dmg).
...
* Download and open [the DMG file](https://github.com/section83/MacYTDL/releases/download/1.14/MacYTDL-v1.14.dmg).
* Read the Help file.
